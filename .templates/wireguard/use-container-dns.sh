...
#    for their DNS,
#
# then this script is what you need. This script:
#
# 1. Expects to be installed at the path:
#
#     ./volumes/wireguard/custom-cont-init.d/use-container-dns.sh
#
# 2. Should be owned root:root with mode 755
#
# 3. Relies on the following clause in the WireGuard
